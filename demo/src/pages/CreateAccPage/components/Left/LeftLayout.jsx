    ...
    return (
        <div className="left-create" >
            ...
            <div className="box">
                <div className="line1">
                    {ARRAYLINE1.map(e => (
                        <Box name={e.title} img={e.img} key={e.title} />
                    ))}
                </div>
                ...
                <div className="line2">
                    ...
                    <div className="box11" id="idbox6">
                        ...
                        <img src="https://scontent.fhan4-3.fna.fbcdn.net/v/t1.15752-9/279936540_3128881534042647_679599628757842846_n.png?_nc_cat=103&ccb=1-7&_nc_sid=ae9488&_nc_ohc=EmI_o7OWylwAX-tZW5p&_nc_ht=scontent.fhan4-3.fna&oh=03_AVIjUSfU-deS8M1Xyec9__vBTFrjCQ0ZqtihhKXRkk2tyg&oe=62AD0336" alt="" className='icon-plus'/>
                        </div>
                    </div>
                </div>
            </div>
